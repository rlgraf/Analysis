#!/usr/bin/env python3
#SBATCH --job-name=azimuthal_analysis_6half_9half_obs25
...
#SBATCH --output=azimuthal_analysis_6half_9half_obs25_%j.txt
...
def Fe_H_agedependent_sd(x1,x2,x3,x4,x5,x6,x7,x8,a1,a2,x9,x10,r,r_form,age_obs,part):
...
def azimuthal_analysis_z_0():
        ...
        for c, (r, r_form) in enumerate(zip(r_array, r_form_array)):
            ...
            for a,b in zip(np.arange(0,14),r90):
                ...
                for a_pre in np.arange(0,1,0.05):
                    Fe_H_azim_pre.append(Fe_H_agedependent_sd(6.5,9.5,0,3,0,15,0,3,a+a_pre,a+a_pre+0.05,0,360,r,r_form,age_obs,part))  
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_profile_z_0_6half_9half_obs25_publish', Fe_H_azim_total) 
