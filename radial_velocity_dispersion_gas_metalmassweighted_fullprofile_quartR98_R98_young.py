#!/usr/bin/env python3
#SBATCH --job-name=radial_velocity_dispersion_gas_metalmassweighted_fullprofile_quartR98_R98_young
...
#SBATCH --output=radial_velocity_dispersion_gas_metalmassweighted_fullprofile_quartR98_R98_young_%j.txt
...
### m12i
    ...
    for (red,r98) in zip(part_snapshots,r98_young_m12i):
        ...
        x = []
        for i in np.arange(r98/4,r98,(r98 - r98/4)/20):
            x.append(velocity_dispersion_gas(i,i+(r98 - r98/4)/20,-3,3,r,v,part))
   ...
   ### m12c
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_dispersion_gas_metalmassweighted_fullprofile_quartR98_R98_young', radial_vel_disp_gas_all_galaxies)
