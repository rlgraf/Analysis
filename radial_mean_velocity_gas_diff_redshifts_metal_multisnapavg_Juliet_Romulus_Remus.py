#!/usr/bin/env python3
#SBATCH --job-name=radial_mean_velocity_gas_diff_redshifts_metal_multisnapavg_Juliet_Romulus_Remus
...
#SBATCH --output=radial_mean_velocity_gas_diff_redshifts_metal_multisnapavg_Juliet_Romulus_Remus_%j.txt
...
def radial_vel_disp_gas():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_mean_gas_z_0_diffredshifts_metalmassweighted_multisnapavg_Juliet_Romulus_Remus', radial_vel_disp_gas_all_galaxies)
