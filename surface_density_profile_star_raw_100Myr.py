#!/usr/bin/env python3
#SBATCH --job-name=surface_density_profile_star_raw_100Myr
...
#SBATCH --output=surface_density_profile_star_raw_100Myr_%j.txt
...
def radial_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surface_density_profile_star_raw_100Myr_pthresh4', surf_dens_ratio_all_galaxies)
