#!/usr/bin/env python3
#SBATCH --job-name=vertical_velocity_dispersion_gas_diffredshifts_massfracweighted_multisnapavg_m12m_m12b_Romeo
...
#SBATCH --output=vertical_velocity_dispersion_gas_diffredshifts_massfracweighted_multisnapavg_m12m_m12b_Romeo_%j.txt
...
### m12m
   ...
   ### m12b
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/vertical_velocity_dispersion_gas_diffredshifts_massfracweighted_multisnapavg_m12m_m12b_Romeo', radial_vel_disp_gas_all_galaxies)
