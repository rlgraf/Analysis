#!/usr/bin/env python3
#SBATCH --job-name=azimuthal_analysis_4half_12
...
#SBATCH --output=azimuthal_analysis_4half_12_%j.txt
...
def azimuthal_analysis_z_0():
        ...
        for c, (r, r_form) in enumerate(zip(r_array, r_form_array)):
            ...
            for a,b in zip(np.arange(0,14),r90):
                ...
                for a_pre in np.arange(0,1,0.05):
                    Fe_H_azim_pre.append(Fe_H_agedependent_sd(4.5,12,0,3,0,b,0,3,a+a_pre,a+a_pre+0.05,0,360,r,r_form,age,part))  
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_profile_z_0_4half_12', Fe_H_azim_total) 
...
def azimuthal_analysis_form():
        ...
        for c, (r, r_form) in enumerate(zip(r_array, r_form_array)):
            ...
            for a_f,b_f in zip(np.arange(0,14), r90):
                ...
                for a_f_pre in np.arange(0,1,0.05):
                      Fe_H_azim_pre_f.append(Fe_H_agedependent_sd_form(4.5,12,0,3,0,30,0,3,a_f+a_f_pre,a_f+a_f_pre+0.05,0,360,r_form,r,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_profile_form_4half_12', Fe_H_azim_form_total) 
