            ...
            for a_f in np.arange(0,13):
                ...
                for a_pre_f in np.arange(0,1,0.1):
                    ...
                    for i_f in np.arange(0,1,0.1):
                        x_f.append(Fe_H_agedependent_form(0,15,i_f,i_f+0.1,1,2,0,1,a_f+a_pre_f,a_f+a_pre_f+0.1,r_form,r,age,part))
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a_f in np.arange(0,13):
                ...
                for a_pre_f in np.arange(0,1,0.1):
                    x_f = []
                    for i_f in np.arange(0,1,0.1):
                        x_f.append(Fe_H_agedependent_form(0,15,i_f,i_f+0.1,4,5,0,1,a_f+a_pre_f,a_f+a_pre_f+0.1,r_form,r,age,part))
                    Fe_H_ver_pre_f.append(x_f)
                Fe_H_ver_pre_f = np.array(Fe_H_ver_pre_f)
                Fe_H_ver_pre_f_mean = np.nanmean(Fe_H_ver_pre_f,0)
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a_f in np.arange(0,13):
                ...
                for a_pre_f in np.arange(0,1,0.1):
                    x_f = []
                    for i_f in np.arange(0,1,0.1):
                        x_f.append(Fe_H_agedependent_form(0,15,i_f,i_f+0.1,7,8,0,1,a_f+a_pre_f,a_f+a_pre_f+0.1,r_form,r,age,part))
                    Fe_H_ver_pre_f.append(x_f)
                Fe_H_ver_pre_f = np.array(Fe_H_ver_pre_f)
                Fe_H_ver_pre_f_mean = np.nanmean(Fe_H_ver_pre_f,0)
