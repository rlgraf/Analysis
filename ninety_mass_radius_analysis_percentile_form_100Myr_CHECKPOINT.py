#!/usr/bin/env python3
#SBATCH --job-name=ninety_mass_radius_analysis_percentile_form_100Myr_CHECKPOINT
...
#SBATCH --output=ninety_mass_radius_analysis_percentile_form_100Myr_CHECKPOINT_%j.txt
...
def half_mass_radius_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/90_mass_radius_form_100Myr_CHECKPOINT', half_mass_radius_galaxy)
