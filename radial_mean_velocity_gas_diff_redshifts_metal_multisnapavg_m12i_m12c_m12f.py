#!/usr/bin/env python3
#SBATCH --job-name=radial_mean_velocity_gas_diff_redshifts_metal_multisnapavg_m12i_m12c_m12f
...
#SBATCH --output=radial_mean_velocity_gas_diff_redshifts_metal_multisnapavg_m12i_m12c_m12f_%j.txt
...
### m12i
   ...
   ### m12c
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_mean_gas_z_0_diffredshifts_metalmassweighted_multisnapavg_m12i_m12c_m12f', radial_vel_disp_gas_all_galaxies)
