#!/usr/bin/env python3
#SBATCH --job-name=angular_momentum_analysis_j98
...
#SBATCH --output=angular_momentum_analysis_j98%j.txt
...
def radial_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/angular_momentum_j98_profile_z_0', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/angular_momentum_j98_slope_z_0', slope_total)
...
def radial_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/angular_momentum_j98_profile_form', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/angular_momentum_j98_slope_form', slope_form_total)
