    ...
    for s in sim:
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a_f in np.arange(0,1,0.05):
                Fe_H_angmom_form = Fe_H_agedependent_sd_form(angmom_mean_form - 0.07,angmom_mean_form + 0.07,0,3,0,15,0,3,a,a+0.05,0,360,r,r_form,age,part,angmom_totvalues,particle_thresh = 100)
