#!/usr/bin/env python3
#SBATCH --job-name=surface_density_profile_abs_z_0
...
#SBATCH --output=surface_density_profile_abs_z_0_%j.txt
...
def surf_dens_log_frac_z_0(x1,x2,x3,x4,x5,x6,a1,a2,r,r_form,age,part,particle_thresh = 16):
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for a in np.arange(0,14):
                ...
                for i in np.arange(0,20):
                    x.append(surf_dens_log_frac_z_0(i,i+1,-3,3,0,30,a,14,r,r_form,age,part))
