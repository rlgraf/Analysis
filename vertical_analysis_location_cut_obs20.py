#!/usr/bin/env python3
#SBATCH --job-name=vertical_analysis_location_cut_obs20
...
#SBATCH --output=vertical_analysis_location_cut_obs20%j.txt
...
def vertical_analysis_z_0():
    ...
    for s in sim:
        ...
        age_obs = age*10**(np.random.normal(0, np.log10(1.2), age.size))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_7_8_z_0_location_cut_obs20', Fe_H_ver_r_7_8_total)
    
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_7_8_z_0_location_cut_obs20', slope_ver_r_7_8_total)
