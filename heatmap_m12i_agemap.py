#!/usr/bin/env python3
#SBATCH --job-name=heatmap_m12i_agemap
...
#SBATCH --output=heatmap_m12i_agemap%j.txt
...
def heatmap():
    ...
    heatmap_data = np.vstack([x_coord, y_coord, age_cut])

    ut_io.file_hdf5('/home/rlgraf/Final_Figures/heatmap_data_m12i_agemap', heatmap_data)
