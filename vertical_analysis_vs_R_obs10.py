#!/usr/bin/env python3
#SBATCH --job-name=vertical_analysis_vs_R_obs10
...
#SBATCH --output=vertical_analysis_vs_R_obs10_%j.txt
...
def Fe_H_agedependent(x1,x2,x3,x4,x5,x6,x7,x8,a1,a2,r,r_form,age_obs,part, particle_thresh = 4):
...
def radial_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_z_0_vs_R_obs10', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_z_0_vs_R_obs10', slope_total)

# formation

def Fe_H_agedependent_form(x1,x2,x3,x4,x5,x6,x7,x8,a1,a2,r_form,r,age_obs,part, particle_thresh = 4):
...
def radial_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_form_vs_R_obs10', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_form_vs_R_obs10', slope_form_total)
