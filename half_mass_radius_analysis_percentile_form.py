...
def half_mass_radius_form(x1,x2,x3,x4,a1,a2,r,r_form,age,part):
    ...
    index2 = ut.array.get_indices(r_form[:,0], [x3,x4], prior_indices = index1)
...
def half_mass_radius_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/half_mass_radius_form_physical_v2', half_mass_radius_galaxy)
