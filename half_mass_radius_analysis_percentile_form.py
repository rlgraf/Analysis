...
def half_mass_radius_form(x1,x2,x3,x4,a1,a2,r,r_form,age,part):
    ...
    mass_cut = ut.math.percentile_weighted(r_form[:,0][index3], 50, weights = part['star']['mass'])
...
def half_mass_radius_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/half_mass_radius_form_v4', half_mass_radius_galaxy)
