#!/usr/bin/env python3
#SBATCH --job-name=radial_velocity_dispersion_gas_metalmassweighted_mean_thirdR90_R90_young_CHECKPOINT
...
#SBATCH --output=radial_velocity_dispersion_gas_metalmassweighted_mean_thirdR90_R90_young_CHECKPOINT_%j.txt
...
### m12i
    ...
    for (red,r90) in zip(part_snapshots,R90_young_m12i):
        ...
        vel_disp_at_snapshot.append(velocity_dispersion_gas(r90/3,r90,-3,3,r,v,part))
   ...
   ### m12c
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_dispersion_gas_metalmassweighted_mean_thirdR90_R90_young_CHECKPOINT', radial_vel_disp_gas_all_galaxies)
