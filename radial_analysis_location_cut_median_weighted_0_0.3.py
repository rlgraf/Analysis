#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_location_cut_median_weighted_0_0.3
...
#SBATCH --output=radial_analysis_location_cut_median_weighted_0_0.3%j.txt
...
def radial_analysis_z_0():
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for a, b in zip(np.arange(0,14), r90):
                ...
                for i in np.arange(0,15,15/10):
                    x.append(Fe_H_agedependent(i,i+15/10,0,0.3,0,b,0,0.3,a,a+1,r,r_form,age,part))
                Fe_H_rad.append(x)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_profile_z_0_location_cut_median_weighted_0_0.3', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_z_0_location_cut_median_weighted_0_0.3', slope_total)
...
def radial_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_profile_form_location_cut_median_weighted_0_0.3', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_form_location_cut_median_weighted_0_0.3', slope_form_total)
