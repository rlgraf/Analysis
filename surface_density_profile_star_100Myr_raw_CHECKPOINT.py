#!/usr/bin/env python3
#SBATCH --job-name=surface_density_profile_star_100Myr_raw_CHECKPOINT
...
#SBATCH --output=surface_density_profile_star_100Myr_raw_CHECKPOINT_%j.txt
...
### m12i
    ...
    for red in part_snapshots:
        ...
        for i in np.arange(0,15,0.5):
            x.append(surf_dens_log_frac(i,i+0.5,-3,3,0,0.1,r,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surface_density_profile_star_100Myr_raw_CHECKPOINT', surf_dens_ratio_gas_all_galaxies)
