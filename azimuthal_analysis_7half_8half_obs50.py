#!/usr/bin/env python3
#SBATCH --job-name=azimuthal_analysis_7half_8half_obs50
...
#SBATCH --output=azimuthal_analysis_7half_8half_obs50_%j.txt
...
def azimuthal_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_profile_z_0_7half_8half_obs50_publish2', Fe_H_azim_total) 
