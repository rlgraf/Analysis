...
def angmom_func(x1,x2,x3,x4,x5,x6,x7,x8,a1,a2,r,r_form,age,part, particle_thresh = 100):
    ...
    index7 = ut.array.get_indices(angmom, [mean_angmom - 0.01*mean_angmom, mean_angmom + 0.01*mean_angmom], prior_indices = index3)
...
def azimuthal_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_angmom_z_0_starcount_0.01', range_j)  
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_radius_z_0_starcount_0.01', range_r) 
...
def angmom_func_form(x1,x2,x3,x4,x5,x6,x7,x8,a1,a2,r,r_form,age,part, particle_thresh = 100):
    ...
    index7 = ut.array.get_indices(angmom_form, [mean_angmom_form - 0.01*mean_angmom_form, mean_angmom_form + 0.01*mean_angmom_form], prior_indices = index3)
...
def azimuthal_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_angmom_form_starcount_0.01', range_j_f)  
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_radius_form_starcount_0.01', range_r_f)
