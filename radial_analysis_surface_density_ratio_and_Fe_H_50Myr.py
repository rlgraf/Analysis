#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_surface_density_ratio_and_Fe_H_50Myr
...
#SBATCH --output=radial_analysis_surface_density_ratio_and_Fe_H_50Myr_%j.txt
...
def radial_analysis_form():
    ...
    for red in part_snapshots:
        ...
        for i_f in np.arange(0,15,0.5):
            ...
            surf_dens_ratio.append(log_surf_dens_ratio(i_f,i_f+0.5,-3,3,0,0.05,r_star,r_gas,age,part))
