#!/usr/bin/env python3
#SBATCH --job-name=vertical_velocity_dispersion_gas_metalmassweighted_fullprofile_quartR90_R90_young
...
#SBATCH --output=vertical_velocity_dispersion_gas_metalmassweighted_fullprofile_quartR90_R90_young_%j.txt
...
### m12i
    ...
    for (red,r90) in zip(part_snapshots,R90_young_m12i):
        ...
        x = []
        for i in np.arange(r90/4,r90,(r90 - r90/4)/20):
            x.append(velocity_dispersion_gas(i,i+(r90 - r90/4)/20,-3,3,r,v,part))
   ...
   ### m12c
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/vertical_velocity_dispersion_gas_metalmassweighted_fullprofile_quartR90_R90_young', radial_vel_disp_gas_all_galaxies)
