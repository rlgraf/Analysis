#!/usr/bin/env python3
#SBATCH --job-name=radial_mean_velocity_gas_diff_redshifts_totmass_multisnapavg_m12m_m12b_Romeo
...
#SBATCH --output=radial_mean_velocity_gas_diff_redshifts_totmass_multisnapavg_m12m_m12b_Romeo_%j.txt
...
def radial_vel_disp_gas():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_mean_gas_z_0_diffredshifts_massweighted_multisnapavg_m12m_m12b_Romeo', radial_vel_disp_gas_all_galaxies)
