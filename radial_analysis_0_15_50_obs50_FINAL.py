#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_0_15_50_obs50_FINAL
...
#SBATCH --output=radial_analysis_0_15_50_obs50_FINAL_%j.txt
...
def radial_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_profile_z_0_0_15_50_obs50_FINAL', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_z_0_0_15_50_obs50_FINAL', slope_total)
