...
def azimuthal_analysis_z_0():
        ...
        for c, (r, r_form) in enumerate(zip(r_array, r_form_array)):
            ...
            for a,b in zip(np.arange(0,14),r90):
                ...
                for a_pre in np.arange(0,1,0.05):
                    Fe_H_azim_pre.append(Fe_H_agedependent_sd(0,20,0,1,0,30,a+a_pre,a+a_pre+0.05,0,360,r,r_form,age,part))  
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_profile_z_0_0_20_FINAL_Z1', Fe_H_azim_total) 
...
def azimuthal_analysis_form():
        ...
        for c, (r, r_form) in enumerate(zip(r_array_spherical, r_form_array)):
            ...
            for a_f,b_f in zip(np.arange(0,14), r90):
                ...
                for a_f_pre in np.arange(0,1,0.05):
                      Fe_H_azim_pre_f.append(Fe_H_agedependent_sd_form(0,20,0,1,0,30,a_f+a_f_pre,a_f+a_f_pre+0.05,0,360,r_form,r,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_profile_form_0_20_FINAL_Z1', Fe_H_azim_form_total) 
