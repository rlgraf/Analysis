#!/usr/bin/env python3
#SBATCH --job-name=azimuthal_analysis_obs50_form
...
#SBATCH --output=azimuthal_analysis_obs50_form_%j.txt
...
def azimuthal_analysis_form():
            ...
            for a_f,b_f in zip(np.arange(0,14), r90):
                ...
                for a_f_pre in np.arange(0,1,0.05):
                    ...
                    for i_f in np.arange(0,b_f,b_f/10):
                        std_vs_rad_f.append(Fe_H_agedependent_sd_form(i_f,i_f+b_f/10,0,3,0,30,0,3,a_f+a_f_pre,a_f+a_f_pre+0.05,0,360,r_form,r,age_obs,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_profile_obs50_form', Fe_H_azim_form_total) 
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_slope_obs50_form', slope_azim_form_total) 
