#!/usr/bin/env python3
#SBATCH --job-name=velocity_dispersion_gas_diffredshifts_massfracweighted_multisnapavg_m12i_m12c_m12f
...
#SBATCH --output=velocity_dispersion_gas_diffredshifts_massfracweighted_multisnapavg_m12i_m12c_m12f_%j.txt
...
### m12i
   ...
   ### m12c
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_dispersion_gas_diffredshifts_massfracweighted_multisnapavg_m12i_m12c_m12f', radial_vel_disp_gas_all_galaxies)
