#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_z_0_R90_revision
...
#SBATCH --output=radial_analysis_z_0_R90_revision_%j.txt
...
R90 = np.array([10.1, 9.2, 13.5, 11.9, 9.2, 14.2, 9.5, 14.8, 12.4, 11.7, 12.6])
...
def radial_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_z_0_R90_revision', slope_total)
