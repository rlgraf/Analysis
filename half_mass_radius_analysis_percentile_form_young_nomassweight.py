#!/usr/bin/env python3
#SBATCH --job-name=half_mass_radius_analysis_percentile_form_young_nomassweight
...
#SBATCH --output=half_mass_radius_analysis_percentile_form_young_nomassweight_%j.txt
...
def half_mass_radius_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/90_mass_radius_form_spherical_100Myr_30kpc_nomassweight', half_mass_radius_galaxy)
