#!/usr/bin/env python3
#SBATCH --job-name=azimuthal_analysis_6half_9half_obs50
...
def azimuthal_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AZIM_profile_z_0_6half_9half_obs50_publish', Fe_H_azim_total) 
