#!/usr/bin/env python3
#SBATCH --job-name=radial_velocity_gas_metalmassweighted_mean_quartR90_R90
...
#SBATCH --output=radial_velocity_gas_metalmassweighted_mean_quartR90_R90_%j.txt
...
### m12i
   ...
   ### m12c
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_gas_metalmassweighted_mean_quartR90_R90', radial_vel_disp_gas_all_galaxies)
