#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_vs_Z
...
#SBATCH --output=radial_analysis_vs_Z_%j.txt
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for Z in np.arange(0,3,0.1):
                for i in np.arange(0,15,15/50):
                    Fe_H_rad.append(Fe_H_agedependent(i,i+15/50,Z,Z+0.1,15,-3,3,0,14,r,r_form,age,part))
