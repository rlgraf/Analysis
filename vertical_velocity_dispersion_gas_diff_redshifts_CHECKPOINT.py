#!/usr/bin/env python3
#SBATCH --job-name=vertical_velocity_dispersion_gas_diff_redshifts_CHECKPOINT
...
#SBATCH --output=vertical_velocity_dispersion_gas_diff_redshifts_CHECKPOINT_%j.txt
...
### m12i
   ...
   ### m12c
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/vertical_velocity_dispersion_gas_z_0_diffredshifts_massweighted_CHECKPOINT', radial_vel_disp_gas_all_galaxies)
