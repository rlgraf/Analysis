#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_surface_density_ratio_and_Fe_H_100Myr_quartR90_R90_young_minislope
...
#SBATCH --output=radial_analysis_surface_density_ratio_and_Fe_H_100Myr_quartR90_R90_young_minislope_%j.txt
