#!/usr/bin/env python3
#SBATCH --job-name=age_analysis_0_15_50
...
#SBATCH --output=age_analysis_0_15_50_%j.txt
...
def Fe_H_agedependent(x1,x2,x3,x4,x5,x6,r,r_form,age,part, particle_thresh = 16):
    ...
    age_cut = age[index3]
    if len(age_cut) < particle_thresh:
        return(np.nan)
    age_avg = np.median(age_cut)
    return(age_avg)
...
def radial_analysis_z_0():
    ...
    for q, s in enumerate(sim):
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for i in np.arange(0,15,15/50):
                Fe_H_rad.append(Fe_H_agedependent(i,i+15/50,-3,3,0,30,r,r_form,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AGE_profile_z_0_0_15_50', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AGE_slope_z_0_0_15_50', slope_total)

# formation

def Fe_H_agedependent_form(x1,x2,x3,x4,x5,x6,r_form,r,age,part, particle_thresh = 16):
...
def radial_analysis_form():
    ...
    for q, s in enumerate(sim):
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):    
            ...
            for i_f in np.arange(0,15,15/50):
                Fe_H_rad_form.append(Fe_H_agedependent_form(i_f,i_f+15/50,-3,3,0,30,r_form,r,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AGE_profile_form_0_15_50', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/AGE_slope_form_0_15_50', slope_form_total)
