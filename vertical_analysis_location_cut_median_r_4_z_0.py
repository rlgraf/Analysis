#!/usr/bin/env python3
#SBATCH --job-name=vertical_analysis_location_cut_median_r_4_z_0
...
#SBATCH --output=vertical_analysis_location_cut_median_r_4_z_0_%j.txt
...
def vertical_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_4_z_0_location_cut_median_weighted_publish2', Fe_H_ver_r_1_2_z_0_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_4_z_0_location_cut_median_weighted_publish2', slope_ver_r_1_2_z_0_total)
