#!/usr/bin/env python3
#SBATCH --job-name=vertical_analysis_vs_Reff
...
#SBATCH --output=vertical_analysis_vs_Reff_%j.txt
...
def radial_analysis_z_0():
    ...
    for q, (s,r90) in enumerate(zip(sim,R90_all_z_0):
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for i in np.arange(0,1,0.1):
                Fe_H_rad.append(Fe_H_agedependent(R-0.5,R+0.5,i,i+0.1,R-0.5,R+0.5,0,1,0,14,r,r_form,age,part))
            l = np.arange(0,1,0.1)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_z_0_vs_reff_Z_loc_cut', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_z_0_vs_reff_Z_loc_cut', slope_total)
