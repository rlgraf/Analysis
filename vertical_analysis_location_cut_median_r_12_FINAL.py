...
def vertical_analysis_z_0():
            ...
            for a in np.arange(0,14):
                ...
                for a_pre in np.arange(0,1,0.1):
                    ...
                    for i in np.arange(0,1,0.1):
                        ...
                        # for R = 4 and R = 8, input the first and second args in Fe_H_agedependent as 3.5,4.5 and 7.5,8.5 respectively
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_12_z_0_location_cut_median_weighted_FINAL2', Fe_H_ver_r_1_2_z_0_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_12_z_0_location_cut_median_weighted_FINAL2', slope_ver_r_1_2_z_0_total)
...
def vertical_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_12_form_location_cut_median_weighted_FINAL3', Fe_H_ver_r_1_2_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_12_form_location_cut_median_weighted_FINAL3', slope_ver_r_1_2_form_total)
