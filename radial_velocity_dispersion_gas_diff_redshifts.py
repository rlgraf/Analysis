#!/usr/bin/env python3
#SBATCH --job-name=radial_velocity_dispersion_gas_diff_redshifts
...
#SBATCH --output=radial_velocity_dispersion_gas_diff_redshifts_%j.txt
...
### m12i
    ...
    for red in part_snapshots:
        part = gizmo.io.Read.read_snapshots(['gas'], 'redshift', red, simulation_directory, properties = ['mass', 'position', 'velocity'], assign_hosts_rotation=True)
   ...
   ### m12c
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_dispersion_gas_z_0_diffredshifts', radial_vel_disp_gas_all_galaxies)
