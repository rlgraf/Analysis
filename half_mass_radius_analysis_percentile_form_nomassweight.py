#!/usr/bin/env python3
#SBATCH --job-name=half_mass_radius_analysis_percentile_form_nomassweight
...
#SBATCH --output=half_mass_radius_analysis_percentile_form_nomassweight_%j.txt
...
def half_mass_radius_form(x1,x2,x3,x4,a1,a2,r_form_cylindrical,r_form_spherical,age,part):
    ...
    if len(r_form_spherical[:,0][index3]) == 0:
        ...
        mass_cut = ut.math.percentile_weighted(r_form_spherical[:,0][index3], 50)
        return(mass_cut)
...
def half_mass_radius_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/50_mass_radius_form_spherical_30kpc_nomassweight', half_mass_radius_galaxy)
