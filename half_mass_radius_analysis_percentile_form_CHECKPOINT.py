#!/usr/bin/env python3
#SBATCH --job-name=half_mass_radius_analysis_percentile_form_CHECKPOINT
...
#SBATCH --output=half_mass_radius_analysis_percentile_form_CHECKPOINT_%j.txt
...
def half_mass_radius_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/50_mass_radius_form_CHECKPOINT', half_mass_radius_galaxy)
