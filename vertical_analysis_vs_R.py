...
def radial_analysis_z_0():
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for R in np.arange(0.5,15.5,1):
                ...
                for i in np.arange(0,1,0.1):
                    x.append(Fe_H_agedependent(R,R+1,i,i+0.1,R,R+1,0,1,0,14,r,r_form,age,part))
                Fe_H_rad.append(x)
                l = np.arange(0,1,0.1)
                x = np.array(x)
                if np.isnan(x).all():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_z_0_vs_R_Z_loc_cut', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_z_0_vs_R_Z_loc_cut', slope_total)
...
def radial_analysis_form():
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):    
            ...
            for R_f in np.arange(0.5,15.5,1):
                ...
                for i_f in np.arange(0,1,0.1):
                    x_f.append(Fe_H_agedependent_form(R_f,R_f+1,i_f,i_f+0.1,R_f,R_f+1,0,1,0,14,r_form,r,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_form_vs_R_Z_loc_cut', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_form_vs_R_Z_loc_cut', slope_form_total)
