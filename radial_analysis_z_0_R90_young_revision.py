#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_z_0_R90_young_revision
...
#SBATCH --output=radial_analysis_z_0_R90_young_revision_%j.txt
...
def radial_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_z_0_R90_young_revision', slope_total)
