#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_location_cut_median_weighted_all_ages
...
#SBATCH --output=radial_analysis_location_cut_median_weighted_all_ages%j.txt
