#!/usr/bin/env python3
#SBATCH --job-name=CARBON_vertical_analysis_vs_R
...
#SBATCH --output=CARBON_vertical_analysis_vs_R_%j.txt
...
def radial_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/CARBON_VER_profile_z_0_vs_R2', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/CARBON_VER_slope_z_0_vs_R2', slope_total)
...
def radial_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/CARBON_VER_profile_form_vs_R2', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/CARBON_VER_slope_form_vs_R2', slope_form_total)
