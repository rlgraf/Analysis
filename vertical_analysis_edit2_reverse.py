#!/usr/bin/env python3
#SBATCH --job-name=vertical_analysis_edit2_reverse
...
#SBATCH --output=vertical_analysis_edit2_reverse_%j.txt
...
def vertical_analysis_z_0():
            ...
            for a in np.arange(0,13):
                ...
                for a_pre in np.arange(0,1,0.1):
                    ...
                    for i in np.arange(0,1,0.1):
                        x.append(Fe_H_agedependent(0,15,i,i+0.1,1,2,0,1,a+a_pre,a+a_pre+0.1,r,r_form,age,part))
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a in np.arange(0,13):
                ...
                for a_pre in np.arange(0,1,0.1):
                    x = []
                    for i in np.arange(0,1,0.1):
                        x.append(Fe_H_agedependent(0,15,i,i+0.1,4,5,0,1,a+a_pre,a+a_pre+0.1,r,r_form,age,part))
                    Fe_H_ver_pre.append(x)
                Fe_H_ver_pre = np.array(Fe_H_ver_pre)
                Fe_H_ver_pre_mean = np.nanmean(Fe_H_ver_pre,0)
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a in np.arange(0,13):
                ...
                for a_pre in np.arange(0,1,0.1):
                    x = []
                    for i in np.arange(0,1,0.1):
                        x.append(Fe_H_agedependent(0,15,i,i+0.1,7,8,0,1,a+a_pre,a+a_pre+0.1,r,r_form,age,part))
                    Fe_H_ver_pre.append(x)
                Fe_H_ver_pre = np.array(Fe_H_ver_pre)
                Fe_H_ver_pre_mean = np.nanmean(Fe_H_ver_pre,0)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_1_2_z_0_edit2_reverse', Fe_H_ver_r_1_2_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_4_5_z_0_edit2_reverse', Fe_H_ver_r_4_5_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_7_8_z_0_edit2_reverse', Fe_H_ver_r_7_8_total)
    
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_1_2_z_0_edit2_reverse', slope_ver_r_1_2_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_4_5_z_0_edit2_reverse', slope_ver_r_4_5_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_7_8_z_0_edit2_reverse', slope_ver_r_7_8_total)
...
def vertical_analysis_form():
            ...
            for a_f in np.arange(0,13):
                ...
                for a_pre_f in np.arange(0,1,0.1):
                    ...
                    for i_f in np.arange(0,1,0.1):
                        x_f.append(Fe_H_agedependent_form(1,2,i_f,i_f+0.1,0,15,0,1,a_f+a_pre_f,a_f+a_pre_f+0.1,r_form,r,age,part))
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a_f in np.arange(0,13):
                ...
                for a_pre_f in np.arange(0,1,0.1):
                    x_f = []
                    for i_f in np.arange(0,1,0.1):
                        x_f.append(Fe_H_agedependent_form(4,5,i_f,i_f+0.1,0,15,0,1,a_f+a_pre_f,a_f+a_pre_f+0.1,r_form,r,age,part))
                    Fe_H_ver_pre_f.append(x_f)
                Fe_H_ver_pre_f = np.array(Fe_H_ver_pre_f)
                Fe_H_ver_pre_f_mean = np.nanmean(Fe_H_ver_pre_f,0)
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a_f in np.arange(0,13):
                ...
                for a_pre_f in np.arange(0,1,0.1):
                    x_f = []
                    for i_f in np.arange(0,1,0.1):
                        x_f.append(Fe_H_agedependent_form(7,8,i_f,i_f+0.1,0,15,0,1,a_f+a_pre_f,a_f+a_pre_f+0.1,r_form,r,age,part))
                    Fe_H_ver_pre_f.append(x_f)
                Fe_H_ver_pre_f = np.array(Fe_H_ver_pre_f)
                Fe_H_ver_pre_f_mean = np.nanmean(Fe_H_ver_pre_f,0)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_1_2_form_edit2_reverse', Fe_H_ver_r_1_2_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_4_5_form_edit2_reverse', Fe_H_ver_r_4_5_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_7_8_form_edit2_reverse', Fe_H_ver_r_7_8_form_total)
    
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_1_2_form_edit2_reverse', slope_ver_r_1_2_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_4_5_form_edit2_reverse', slope_ver_r_4_5_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_7_8_form_edit2_reverse', slope_ver_r_7_8_form_total)
