...
def vertical_analysis_z_0():
    ...
    Fe_H_ver_r_4_5_z_0_total = []
    slope_ver_r_4_5_z_0_total = []
    sim = sim_func()
    for s in sim:
        simulation_directory = s
        part = gizmo.io.Read.read_snapshots(['star'], 'redshift', 0, simulation_directory, assign_hosts_rotation=True, assign_formation_coordinates = True)
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a in np.arange(0,14):
                ...
                for a_pre in np.arange(0,1,0.1):
                    x = []
                    for i in np.arange(0,1,0.1):
                        x.append(Fe_H_agedependent(7.5,8.5,i,i+0.1,0,15,0,1,a+a_pre,a+a_pre+0.1,r,r_form,age,part))
                    Fe_H_ver_pre.append(x)
                Fe_H_ver_pre = np.array(Fe_H_ver_pre)
                Fe_H_ver_pre_mean = np.nanmean(Fe_H_ver_pre,0)
                Fe_H_ver_r_4_5_z_0.append(Fe_H_ver_pre_mean)
                l = np.arange(0,1,0.1)
                if sum(np.isfinite(Fe_H_ver_pre_mean)) < 2:
                    slope_ver_r_4_5_z_0.append(np.nan)
                else:
                    j, k = np.polyfit(l[np.isfinite(Fe_H_ver_pre_mean)],Fe_H_ver_pre_mean[np.isfinite(Fe_H_ver_pre_mean)],1)
                    slope_ver_r_4_5_z_0.append(j)
            Fe_H_ver_r_4_5_z_0_total.append(Fe_H_ver_r_4_5_z_0)
            slope_ver_r_4_5_z_0_total.append(slope_ver_r_4_5_z_0)
    Fe_H_ver_r_4_5_z_0_total = np.array([Fe_H_ver_r_4_5_z_0_total])
    slope_ver_r_4_5_z_0_total = np.array([slope_ver_r_4_5_z_0_total])

    Fe_H_ver_r_7_8_z_0_total = []
    slope_ver_r_7_8_z_0_total = []
    sim = sim_func()
    for s in sim:
        simulation_directory = s
        part = gizmo.io.Read.read_snapshots(['star'], 'redshift', 0, simulation_directory, assign_hosts_rotation=True, assign_formation_coordinates = True)
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a in np.arange(0,14):
                ...
                for a_pre in np.arange(0,1,0.1):
                    x = []
                    for i in np.arange(0,1,0.1):
                        x.append(Fe_H_agedependent(11.5,12.5,i,i+0.1,0,15,0,1,a+a_pre,a+a_pre+0.1,r,r_form,age,part))
                    Fe_H_ver_pre.append(x)
                Fe_H_ver_pre = np.array(Fe_H_ver_pre)
                Fe_H_ver_pre_mean = np.nanmean(Fe_H_ver_pre,0)
                Fe_H_ver_r_7_8_z_0.append(Fe_H_ver_pre_mean)
                l = np.arange(0,1,0.1)
                if sum(np.isfinite(Fe_H_ver_pre_mean)) < 2:
                    slope_ver_r_7_8_z_0.append(np.nan)
                else:
                    j, k = np.polyfit(l[np.isfinite(Fe_H_ver_pre_mean)],Fe_H_ver_pre_mean[np.isfinite(Fe_H_ver_pre_mean)],1)
                    slope_ver_r_7_8_z_0.append(j)
            Fe_H_ver_r_7_8_z_0_total.append(Fe_H_ver_r_7_8_z_0)
            slope_ver_r_7_8_z_0_total.append(slope_ver_r_7_8_z_0)
    Fe_H_ver_r_7_8_z_0_total = np.array([Fe_H_ver_r_7_8_z_0_total])
    slope_ver_r_7_8_z_0_total = np.array([slope_ver_r_7_8_z_0_total])
...
def vertical_analysis_form():
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a_f in np.arange(0,14):
                ...
                for a_pre_f in np.arange(0,1,0.1):
                    x_f = []
                    for i_f in np.arange(0,1,0.1):
                        x_f.append(Fe_H_agedependent_form(7.5,8.5,i_f,i_f+0.1,0,15,0,1,a_f+a_pre_f,a_f+a_pre_f+0.1,r_form,r,age,part))
                    Fe_H_ver_pre_f.append(x_f)
                Fe_H_ver_pre_f = np.array(Fe_H_ver_pre_f)
                Fe_H_ver_pre_f_mean = np.nanmean(Fe_H_ver_pre_f,0)
        ...
        for r, r_form in zip(r_array, r_form_array):
            ...
            for a_f in np.arange(0,14):
                ...
                for a_pre_f in np.arange(0,1,0.1):
                    x_f = []
                    for i_f in np.arange(0,1,0.1):
                        x_f.append(Fe_H_agedependent_form(11.5,12.5,i_f,i_f+0.1,0,15,0,1,a_f+a_pre_f,a_f+a_pre_f+0.1,r_form,r,age,part))
                    Fe_H_ver_pre_f.append(x_f)
                Fe_H_ver_pre_f = np.array(Fe_H_ver_pre_f)
                Fe_H_ver_pre_f_mean = np.nanmean(Fe_H_ver_pre_f,0)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_4_z_0_location_cut_median_weighted_publish', Fe_H_ver_r_1_2_z_0_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_8_z_0_location_cut_median_weighted_publish', Fe_H_ver_r_4_5_z_0_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_12_z_0_location_cut_median_weighted_publish', Fe_H_ver_r_7_8_z_0_total)
    
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_4_form_location_cut_median_weighted_publish', slope_ver_r_1_2_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_8_form_location_cut_median_weighted_publish', slope_ver_r_4_5_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_12_form_location_cut_median_weighted_publish', slope_ver_r_7_8_form_total)
