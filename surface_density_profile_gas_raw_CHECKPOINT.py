#!/usr/bin/env python3
#SBATCH --job-name=surface_density_profile_gas_raw_CHECKPOINT
...
#SBATCH --output=surface_density_profile_gas_raw_CHECKPOINT_%j.txt
...
### m12i
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surface_density_profile_gas_raw_CHECKPOINT', surf_dens_ratio_gas_all_galaxies)
