#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_thindisk
...
#SBATCH --output=radial_analysis_thindisk_%j.txt
...
def radial_analysis_z_0():
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for a, b in zip(np.arange(0,14), r90):
                ...
                for i in np.arange(0,b,b/10):
                    x.append(Fe_H_agedependent(i,i+b/10,-0.3,0.3,0,b,-0.3,0.3,a,a+1,r,r_form,age,part))
                Fe_H_rad.append(x)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_profile_z_0_thindisk', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_z_0_thindisk', slope_total)
...
def radial_analysis_form():
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):    
            ...
            for a_f, b_f in zip(np.arange(0,14), r90):
                ...
                for i_f in np.arange(0,b_f,b_f/10):
                    x_f.append(Fe_H_agedependent_form(i_f,i_f+b_f/10,-0.3,0.3,0,b_f,-0.3,0.3,a_f,a_f+1,r_form,r,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_profile_form_thindisk', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_form_thindisk', slope_form_total)
