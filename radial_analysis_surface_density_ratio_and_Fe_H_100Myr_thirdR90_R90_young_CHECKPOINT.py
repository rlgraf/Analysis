#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_surface_density_ratio_and_Fe_H_100Myr_thirdR90_R90_young_CHECKPOINT
...
#SBATCH --output=radial_analysis_surface_density_ratio_and_Fe_H_100Myr_thirdR90_R90_young_CHECKPOINT_%j.txt
...
def radial_analysis_form():
    ...
    for (red,r90) in zip(part_snapshots,R90_young_m12i):
        ...
        x_f = []
        surf_dens_ratio = []
        for i_f in np.arange(r90/3,r90,(r90 - r90/3)/20):
            x_f.append(Fe_H_agedependent_form(i_f,i_f+(r90 - r90/3)/20,-3,3,0,0.1,r_star,age,part))
            surf_dens_ratio.append(log_surf_dens_ratio(i_f,i_f+(r90 - r90/3)/20,-3,3,0,0.1,r_star,r_gas,age,part))
            
        Fe_H_rad_form_at_snapshot.append(x_f)
        l_f = np.arange(r90/3,r90,(r90 - r90/3)/20)
        x_f = np.array(x_f)
        if np.isnan(x_f).all():
        ...
        l_f_s = np.arange(r90/3,r90,(r90 - r90/3)/20)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/Fe_H_rad_form_all_galaxies_surfdensratiotrack_100Myr_thirdR90_R90_young_CHECKPOINT', Fe_H_rad_form_all_galaxies)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_all_galaxies_surfdensratiotrack_100Myr_thirdR90_R90_young_CHECKPOINT', surf_dens_ratio_all_galaxies)
    
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/Fe_H_rad_form_all_galaxies_surfdensratiotrack_100Myr_thirdR90_R90_young_slope_CHECKPOINT', Fe_H_rad_form_all_galaxies_slope)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_all_galaxies_surfdensratiotrack_100Myr_thirdR90_R90_young_slope_CHECKPOINT', surf_dens_ratio_all_galaxies_slope)
