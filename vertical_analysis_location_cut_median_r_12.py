#!/usr/bin/env python3
#SBATCH --job-name=vertical_analysis_location_cut_median_r_12
...
#SBATCH --output=vertical_analysis_location_cut_median_r_12_%j.txt
...
def vertical_analysis_z_0():
            ...
            for a in np.arange(0,14):
                ...
                for a_pre in np.arange(0,1,0.1):
                    ...
                    for i in np.arange(0,1,0.1):
                        x.append(Fe_H_agedependent(0,15,i,i+0.1,11.5,12.5,0,1,a+a_pre,a+a_pre+0.1,r,r_form,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_12_z_0_location_cut_median_weighted_publish_switch', Fe_H_ver_r_1_2_z_0_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_12_z_0_location_cut_median_weighted_publish_switch', slope_ver_r_1_2_z_0_total)
...
def vertical_analysis_form():
            ...
            for a_f in np.arange(0,14):
                ...
                for a_pre_f in np.arange(0,1,0.1):
                    ...
                    for i_f in np.arange(0,1,0.1):
                        x_f.append(Fe_H_agedependent_form(0,15,i_f,i_f+0.1,11.5,12.5,0,1,a_f+a_pre_f,a_f+a_pre_f+0.1,r_form,r,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_profile_r_12_form_location_cut_median_weighted_publish_switch', Fe_H_ver_r_1_2_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/VER_slope_r_12_form_location_cut_median_weighted_publish_switch', slope_ver_r_1_2_form_total)
