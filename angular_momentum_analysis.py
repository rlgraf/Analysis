#!/usr/bin/env python3
#SBATCH --job-name=angular_momentum_analysis
...
#SBATCH --output=angular_momentum_analysis%j.txt
...
def radial_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/angular_momentum_profile_z_0', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/angular_momentum_slope_z_0', slope_total)

# formation

def Fe_H_agedependent_form(x1,x2,x3,x4,x5,x6,x7,x8,a1,a2,r_form,r,age,part, particle_thresh = 100):
    index = ut.array.get_indices(angmomtotvalues_form, [x1,x2])
    index2 = ut.array.get_indices(abs(r_form[:,2]), [x3,x4], prior_indices = index)
    index3 = ut.array.get_indices(angmomtotvalues_form,[x5,x6], prior_indices = index2)
...
def radial_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/angular_momentum_profile_form', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/angular_momentum_slope_form', slope_form_total)
