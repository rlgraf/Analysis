#!/usr/bin/env python3
#SBATCH --job-name=velocity_dispersion_gas_diffredshifts_massfracweighted_multisnapavg_Thelma_Louise
...
#SBATCH --output=velocity_dispersion_gas_diffredshifts_massfracweighted_multisnapavg_Thelma_Louise_%j.txt
...
### Thelma
   ...
   ### Louise
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_dispersion_gas_diffredshifts_massfracweighted_multisnapavg_Thelma_Louise', radial_vel_disp_gas_all_galaxies)
