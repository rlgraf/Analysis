#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_z_0_R90_young_revision_obs50
...
#SBATCH --output=radial_analysis_z_0_R90_young_revision_obs50_%j.txt
...
def Fe_H_agedependent(x1,x2,x3,x4,x5,x6,a1,a2,r,r_form,age_obs,part, particle_thresh = 4):
...
def radial_analysis_z_0():
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for a in np.arange(0,14):
                ...
                for i in np.arange(0,r90,r90/50):
                    x.append(Fe_H_agedependent(i,i+r90/50,-3,3,0,30,a,a+1,r,r_form,age_obs,part))
                Fe_H_rad.append(x)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_z_0_R90_young_revision_obs50', slope_total)
