#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_thickdisk
...
#SBATCH --output=radial_analysis_thickdisk%j.txt
...
def radial_analysis_z_0():
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for a, b in zip(np.arange(0,14), r90):
                ...
                for i in np.arange(0,R90_z_0[q+LG_counter],R90_z_0[q+LG_counter]/10):
                    x.append(Fe_H_agedependent(i,i+R90_z_0[q+LG_counter]/10,2,3,0,b,2,3,a,a+1,r,r_form,age,part))
                Fe_H_rad.append(x)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_profile_z_0_thickdisk', Fe_H_rad_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_z_0_thickdisk', slope_total)

# formation

def Fe_H_agedependent_form(x1,x2,x3,x4,x5,x6,x7,x8,a1,a2,r_form,r,age,part, particle_thresh = 10):
...
def radial_analysis_form():
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):    
            ...
            for a_f, b_f in zip(np.arange(0,14), r90):
                ...
                for i_f in np.arange(0,b_f,b_f/10):
                    x_f.append(Fe_H_agedependent_form(i_f,i_f+b_f/10,2,3,0,30,2,3,a_f,a_f+1,r_form,r,age,part))
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_profile_form_thickdisk', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_form_thickdisk', slope_form_total)
