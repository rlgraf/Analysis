#!/usr/bin/env python3
#SBATCH --job-name=radial_velocity_dispersion_gas_metalmassweighted_fullprofile_quartR90_R90_young
...
#SBATCH --output=radial_velocity_dispersion_gas_metalmassweighted_fullprofile_quartR90_R90_young_%j.txt
...
### m12i
   ...
   ### m12c
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/velocity_dispersion_gas_metalmassweighted_fullprofile_quartR90_R90_young', radial_vel_disp_gas_all_galaxies)
