#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_surface_density_ratio_and_Fe_H_allages_quartR90_R90_young_CHECK2
...
#SBATCH --output=radial_analysis_surface_density_ratio_and_Fe_H_allages_quartR90_R90_young_CHECK2_%j.txt
...
def radial_analysis_form():
    ...
    for (red,r90) in zip(part_snapshots,R90_young_m12i):
        ...
        for i_f in np.arange(r90/4,r90,(r90 - r90/4)/20):
            x_f.append(Fe_H_agedependent_form(i_f,i_f+(r90 - r90/4)/20,-3,3,0,14,r_star,age,part))
            log_surf_ratio = log_surf_dens_ratio(i_f,i_f+(r90 - r90/4)/20,-3,3,0,14,r_star,r_gas,age,part)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/Fe_H_rad_form_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_CHECK2', Fe_H_rad_form_all_galaxies)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_CHECK2', surf_dens_ratio_all_galaxies)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_over_v_vel_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_CHECK2', surf_dens_ratio_over_v_vel_all_galaxies)
    
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/Fe_H_rad_form_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_slope_CHECK2', Fe_H_rad_form_all_galaxies_slope)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_slope_CHECK2', surf_dens_ratio_all_galaxies_slope)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_over_v_vel_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_slope_CHECK2_NEW', surf_dens_ratio_over_v_vel_all_galaxies_slope)
