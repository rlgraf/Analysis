...
def radial_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_over_v_vel_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_slope_CHECK2', surf_dens_ratio_over_v_vel_all_galaxies_slope)
