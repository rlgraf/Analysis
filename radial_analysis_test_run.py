#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_radvelcut
...
#SBATCH --output=radial_analysis_radvelcut_%j.txt
...
def radial_analysis_z_0():
    ...
    for q, s in enumerate(sim):
        ...
        Fe_H = part['star'].prop('host1.metallicity.iron')
...
def radial_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_profile_form_test', Fe_H_rad_form_total)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/RAD_slope_form_test', slope_form_total)
