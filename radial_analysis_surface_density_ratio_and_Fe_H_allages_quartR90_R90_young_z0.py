#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_surface_density_ratio_and_Fe_H_allages_quartR90_R90_young_z0
...
#SBATCH --output=radial_analysis_surface_density_ratio_and_Fe_H_allages_quartR90_R90_young_z0_%j.txt
...
def log_surf_dens_ratio(x1,x2,x3,x4,a1,a2,r_star,r_star_z0,r_gas,age,part,part_z0,particle_thresh = 4):
    ...
    if len(part_z0['star']['mass'][index3]) < particle_thresh or len(part['gas']['mass'][index5]) < particle_thresh:
        return(np.nan)
...
def velocity_dispersion_gas(x1,x2,x3,x4,r_gas,v_gas,part):
    ...
    vel_ver = v_gas[:,2]
    massfrac_iron = part['gas']['massfraction'][:,0]
    #print(np.shape(massfrac_iron[index2]))
    #print(np.shape(vel_ver[index2]))
    #print(np.shape(part['gas']['mass'][index2]))
...
def radial_analysis_form():
    ...
    for (red,r90) in zip(part_snapshots,R90_young_m12i):
        ...
        part_z0 = gizmo.io.Read.read_snapshots(['star','gas'], 'redshift', 0, simulation_directory, properties = ['mass', 'position', 'velocity', 'massfraction', 'form.scalefactor', 'id'], elements = ['Fe'], assign_hosts_rotation=True, assign_formation_coordinates = True)
        ...
        r_star_z0 = part_z0['star'].prop('host.distance.principal.cylindrical')
        ...
        for i_f in np.arange(r90/4,r90,(r90 - r90/4)/20):
            x_f.append(Fe_H_agedependent_form(i_f,i_f+(r90 - r90/4)/20,-3,3,0,14,r_star,r_star_z0,age,part,part_z0))
            log_surf_ratio = log_surf_dens_ratio(i_f,i_f+(r90 - r90/4)/20,-3,3,0,14,r_star,r_star_z0,r_gas,age,part,part_z0)
    ...
    surf_dens_ratio_over_v_vel_all_galaxies = np.array(surf_dens_ratio_over_v_vel_all_galaxies) 
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/Fe_H_rad_form_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_z0', Fe_H_rad_form_all_galaxies)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_z0', surf_dens_ratio_all_galaxies)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_over_v_vel_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_z0', surf_dens_ratio_over_v_vel_all_galaxies)
    
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/Fe_H_rad_form_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_slope_z0', Fe_H_rad_form_all_galaxies_slope)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_slope_z0', surf_dens_ratio_all_galaxies_slope)
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/surf_dens_ratio_over_v_vel_all_galaxies_surfdensratiotrack_allages_quartR90_R90_young_slope_z0', surf_dens_ratio_over_v_vel_all_galaxies_slope)
