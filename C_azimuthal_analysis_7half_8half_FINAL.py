#!/usr/bin/env python3
#SBATCH --job-name=C_azimuthal_analysis_7half_8half_FINAL
...
#SBATCH --output=C_azimuthal_analysis_7half_8half_FINAL_%j.txt
...
def azimuthal_analysis_z_0():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/C_AZIM_profile_z_0_7half_8half_FINAL', Fe_H_azim_total) 
...
def azimuthal_analysis_form():
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/C_AZIM_profile_form_7half_8half_FINAL', Fe_H_azim_form_total) 
