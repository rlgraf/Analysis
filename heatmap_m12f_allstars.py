#!/usr/bin/env python3
#SBATCH --job-name=heatmap_m12f_allstars
...
#SBATCH --output=heatmap_m12f_allstars%j.txt
...
def heatmap():
    sim = '/share/wetzellab/m12f/m12f_r7100/'
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/heatmap_data_m12f_allstars_trial2', heatmap_data)
