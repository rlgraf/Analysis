#!/usr/bin/env python3
#SBATCH --job-name=radial_analysis_location_cut_median_weighted_20_10
...
#SBATCH --output=radial_analysis_location_cut_median_weighted_20_10_%j.txt
        ...
        for j, (r, r_form) in enumerate(zip(r_array,r_form_array)):
            ...
            for a, b in zip(np.arange(0,14), r90):
                ...
                for i in np.arange(0,20,20/10):
                    x.append(Fe_H_agedependent(i,i+20/10,-3,3,0,b,-3,3,a,a+1,r,r_form,age,part))
                Fe_H_rad.append(x)
