#!/usr/bin/env python3
#SBATCH --job-name=heatmap_m12i_0_1
...
#SBATCH --output=heatmap_m12i_0_1%j.txt
...
def heatmap():
    ...
    index3 = ut.array.get_indices(age, [0,1], prior_indices = index2)
    ...
    ut_io.file_hdf5('/home/rlgraf/Final_Figures/heatmap_data_m12i_1_2', heatmap_data)
